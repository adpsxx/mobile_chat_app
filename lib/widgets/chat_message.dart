...
import 'package:mobile_chat_apps/widgets/message_bubble.dart';
        ...
        return ListView.builder(  
          ...
          itemBuilder: (ctx, index) {
            ...
            if (nextUserIsSame) {
              ...
              return MessageBubble.first(userImagePath: 'assets/images/default_user.png', username: chatMessage['username'], message: chatMessage["text"], isMe: authenticatedUser.uid == currentMessageUserId);
            }
          }
        );
      }
